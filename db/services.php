...
/**
 * Theme avadinte functions and service definitions.
 *
...
$functions = array(
    'theme_avadinte_fontsize' => array(
        'classname' => 'theme_avadinte\api\accessibility',
        'classpath' => 'theme_avadinte/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true
    ),
    'theme_avadinte_sitecolor' => array(
        'classname' => 'theme_avadinte\api\accessibility',
    ...
    'theme_avadinte_savethemesettings' => array(
        'classname' => 'theme_avadinte\api\accessibility',
    ...
    'theme_avadinte_getthemesettings' => array(
        'classname' => 'theme_avadinte\api\accessibility',
